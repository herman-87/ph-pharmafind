package com.ph.pharmafind.application.pharmacy.mapper;
...
public interface PharmacyMapper {
  ...
  default PharmacyCreateRequest.PaymentType mapCreatePaymentType(
      PaymentMethodDTO.TypeEnum type) {
    return type == null ? null : PharmacyCreateRequest.PaymentType.valueOf(type.getValue());
  }

  default PharmacyUpdateRequest.PaymentType mapUpdatePaymentType(
      PaymentMethodDTO.TypeEnum type) {
